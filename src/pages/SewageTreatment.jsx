    ...
    <>
      <section className="building-container">
        <div className="building-head-container">
          <h1 className="building-head">Sewage Treatment Plant Management</h1>
        </div>
      </section>
      <section className="body-container">
        <main className="body-hero-container">
          <p>
            We optimize all the stages of treatment procedures involved in
            treating sewage. This is done by analyzing all the types of
            contaminants present in sewage from a particular source. We use
            several sophisticated technologies like Membrane bioreactor,
            activated sludge process, extended aeration, and logging, etc in our
            Sewage treatment systems. By employing the best high-quality
            materials and advanced technologies available, we ensure that our
            plants are efficient, reliable, and cost-effective.
          </p>
          <h2>Capabilities</h2>
          <div className="body-main-container">
            <section className="body-main-list">
              <ul>
                <li>Treated water monitoring</li>
                <li>
